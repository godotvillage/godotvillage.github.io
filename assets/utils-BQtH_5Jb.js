...
## xcount
[xcount](https://space.bilibili.com/351607965) 是B站上专注于Godot游戏引擎教程搬运的up主，他大量搬运YouTube上的优质Godot教学视频，数量庞大约750+，内容主题极其丰富多样，涵盖了Godot开发的各个方面，从基础入门到高级技巧都有涉及，虽然内容庞杂但为需要深入学习特定技术细节的开发者提供了宝贵的资源库，是Godot学习者查找特定解决方案和进阶技术的重要参考来源。`,N=`---
title: 着色器简介
author: 陌上竹
date: 2026-03-23
category:
...
`;function U(e){const t=e.match(/^---\r?\n([\s\S]*?)\r?\n---\r?\n([\s\S]*)$/);if(!t)return{metadata:{},content:e};const r=t[1],i=t[2],o={},u=r.split(/\r?\n/);let n="",a=[];function s(){n&&a.length>0&&(o[n]=a.join(", "),a=[]),n=""}for(const _ of u){const c=_.match(/^\s+-\s+(.*)/);if(c&&n){a.push(c[1].trim());continue}s();const l=_.match(/^(\w+):\s*(.*)/);if(l){const d=l[1],p=l[2].trim();p===""?n=d:o[d]=p}}return s(),{metadata:o,content:i}}function B(e){return e.replace(/<BiliBlackboard\s+width="([^"]*)"\s+link="([^"]*)"\s*\/>/g,(t,r,i)=>`<div class="bilibili-wrapper" style="max-width:${r||"750px"};margin:16px 0;">
  <iframe
  ...
  ></iframe>
</div>`)}export{k as _,G as a,O as b,L as c,V as d,P as e,N as f,R as g,I as h,D as i,M as j,w as k,T as l,E as m,C as n,S as o,U as p,x as q,b as r,h as s,f as t,v as u,y as v,g as w,m as x,B as y};
